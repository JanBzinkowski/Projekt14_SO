...
### ***UWAGA!*** Logger często z nieznanych względów przestaje wypisywać logi do konsoli przy zamykaniu programu (program wygląda jakby się zwiesił). ***Dla pełnych informacji proszę spojrzeć do pliku ```log.txt```.***
